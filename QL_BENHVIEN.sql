...
CREATE TABLE THONGTINBACSI(
	...
	CONSTRAINT P_CHITIETBACSI PRIMARY KEY(MANHANVIEN)
)
...
CREATE TABLE CHITIETHOCVI(
	...
	CONSTRAINT P_CHITIETHOCVI PRIMARY KEY(MANHANVIEN,MAHOCVI)
)
...
ADD CONSTRAINT F_BS_TT FOREIGN KEY(MANHANVIEN) REFERENCES NHANVIEN(MANHANVIEN)

ALTER TABLE TAIKHOAN
ADD CONSTRAINT F_NV_TK FOREIGN KEY(MANHANVIEN) REFERENCES NHANVIEN(MANHANVIEN)

ALTER TABLE CHITIETHOCVI
ADD CONSTRAINT F_CTHV_BS FOREIGN KEY(MANHANVIEN) REFERENCES NHANVIEN(MANHANVIEN);
ALTER TABLE CHITIETHOCVI
...
ADD CONSTRAINT F_LICH_BS FOREIGN KEY(MANHANVIEN) REFERENCES NHANVIEN(MANHANVIEN);

ALTER TABLE LICHLAMVIEC ADD CONSTRAINT FK_L_P FOREIGN KEY (PHONGLAMVIEC) REFERENCES PHONGKHAM(MAPHONG)

INSERT INTO NHANVIEN VALUES ('NV001', N'Bùi Phan Bảo Ngọc ', N'Quản lý', N'Nữ');
INSERT INTO NHANVIEN VALUES ('NV002', N'Nguyễn Phan Như Quỳnh ', N'Thu ngân', N'Nữ');
INSERT INTO NHANVIEN VALUES ('NV003', N'Võ Thị Thanh Trúc', N'Thu ngân', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0001', N'Triệu Triều Dương', N'Giám đốc', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0002', N'Trần Văn Hinh', N'Trưởng khoa', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0003', N'Nguyễn Văn Nghĩa', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0004', N'Tống Văn Khả', N'Dược sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0005', N'Đỗ Thanh Thư', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0006', N'Huỳnh Thị Thanh Trang', N'Phó khoa', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0007', N'Trần Kim Oanh', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0008', N'Trần Đức Minh', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0009', N'Võ Thị Tường Duy', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0010', N'Cam Ngọc Phượng', N'Giám đốc trung tâm', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0011', N'Trần Ngọc Hứu', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0012', N'Nguyễn Thị Liên Hương', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0013', N'Trịnh Tuấn Dũng', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0014', N'Nguyễn Duy Trinh', N'Phó giám đốc', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0015', N'Trần Thị Thanh Trúc', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0016', N'Huỳnh Văn Mười Một', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0017', N'Nguyễn Đức Hưng', N'Phó khoa', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0018', N'Nguyễn Tân Cương', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0019', N'Nguyễn Ngọc Huỳnh', N'Trưởng lap', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0020', N'Dương Quang Huy', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0021', N'Lê Xuân Nguyên', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0022', N'Nguyễn Phạm Thùy Linh', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0023', N'Ngô Trường Sơn', N'Phó trưởng khoa', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0024', N'Lê Thanh Hùng', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0025', N'Tạ Ngọc Thạch', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0026', N'Chế Đình Nghĩa', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0027', N'Ngô Quý Châu', N'Phó tổng giám đốc chuyên môn', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0028', N'Trần Quán Anh', N'Bác sĩ cao cấp', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0029', N'Trần Anh Vũ', N'Cố vấn chuyên môn', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0030', N'Hồ Thị Khánh Quyên', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0031', N'Nguyễn Quang Nhật', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0032', N'Đào Trần Tiến', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0033', N'Hà Thị Loan', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0034', N'Mai Mạnh Tam', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0035', N'Lã Quý Hương', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0036', N'Nguyễn Văn Ngân', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0037', N'Đặng Thành Đô', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0038', N'Thân Thị Ngọc Lan', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0039', N'Trần Duy Hưng', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0040', N'Cẩn Tuyết Nga', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0041', N'Trần Đức Hậu', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0042', N'Lê Thị Lan Anh', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0043', N'Nguyễn Văn Lan', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0044', N'Lê Văn Khánh', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0045', N'Lê Nguyệt Minh', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0046', N'Quảng Thị Bính Thìn', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0047', N'Phạm Thanh Xuân', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0048', N'Phan Thị Phương Thảo', N'Bác sĩ', N'Nữ');
INSERT INTO NHANVIEN VALUES ('BS0049', N'Nguyễn Quốc Khánh', N'Bác sĩ', N'Nam');
INSERT INTO NHANVIEN VALUES ('BS0050', N'Dương Công Lĩnh', N'Bác sĩ', N'Nam');
...
INSERT INTO TAIKHOAN VALUES ('TK0001', 'quanly', N'admin', N'Quản lý', 'NV001');
INSERT INTO TAIKHOAN VALUES ('TK0002', 'nhuquynh', N'123456', N'Thu ngân', 'NV002');
INSERT INTO TAIKHOAN VALUES ('TK0003', 'thanhtruc', N'1234', N'Thu ngân', 'NV003');
INSERT INTO TAIKHOAN VALUES ('TK0004', 'ttd1', N'123', N'Bác sĩ', 'BS0001');
INSERT INTO TAIKHOAN VALUES ('TK0005', 'tvh2', N'123', N'Bác sĩ', 'BS0002');
INSERT INTO TAIKHOAN VALUES ('TK0006', 'nvn3', N'123', N'Bác sĩ', 'BS0003');
INSERT INTO TAIKHOAN VALUES ('TK0007', 'dtt5', N'123', N'Bác sĩ', 'BS0005');
INSERT INTO TAIKHOAN VALUES ('TK0008', 'httt6', N'123', N'Bác sĩ', 'BS0006');
INSERT INTO TAIKHOAN VALUES ('TK0009', 'tko7', N'123', N'Bác sĩ', 'BS0007');
INSERT INTO TAIKHOAN VALUES ('TK0010', 'tdm8', N'123', N'Bác sĩ', 'BS0008');
INSERT INTO TAIKHOAN VALUES ('TK0011', 'vttd9', N'123', N'Bác sĩ', 'BS0010');
INSERT INTO TAIKHOAN VALUES ('TK0012', 'tnh11', N'123', N'Bác sĩ', 'BS0011');
INSERT INTO TAIKHOAN VALUES ('TK0013', 'ntlh12', N'123', N'Bác sĩ', 'BS0012');
INSERT INTO TAIKHOAN VALUES ('TK0014', 'ttd13', N'123', N'Bác sĩ', 'BS0013');
INSERT INTO TAIKHOAN VALUES ('TK0015', 'ndt14', N'123', N'Bác sĩ', 'BS0014');
INSERT INTO TAIKHOAN VALUES ('TK0016', 'tttt15', N'123', N'Bác sĩ', 'BS0015');
INSERT INTO TAIKHOAN VALUES ('TK0017', 'hvmm16', N'123', N'Bác sĩ', 'BS0016');
INSERT INTO TAIKHOAN VALUES ('TK0018', 'ndh17', N'123', N'Bác sĩ', 'BS0017');
INSERT INTO TAIKHOAN VALUES ('TK0019', 'ntc18', N'123', N'Bác sĩ', 'BS0018');
INSERT INTO TAIKHOAN VALUES ('TK0020', 'dqh20', N'123', N'Bác sĩ', 'BS0020');
INSERT INTO TAIKHOAN VALUES ('TK0021', 'lxn21', N'123', N'Bác sĩ', 'BS0021');
INSERT INTO TAIKHOAN VALUES ('TK0022', 'nptl22', N'123', N'Bác sĩ', 'BS0022');
INSERT INTO TAIKHOAN VALUES ('TK0023', 'nts23', N'123', N'Bác sĩ', 'BS0023');
INSERT INTO TAIKHOAN VALUES ('TK0024', 'lth24', N'123', N'Bác sĩ', 'BS0024');
INSERT INTO TAIKHOAN VALUES ('TK0025', 'tnt25', N'123', N'Bác sĩ', 'BS0025');
INSERT INTO TAIKHOAN VALUES ('TK0026', 'cdn26', N'123', N'Bác sĩ', 'BS0026');
INSERT INTO TAIKHOAN VALUES ('TK0027', 'nqc27', N'123', N'Bác sĩ', 'BS0027');
INSERT INTO TAIKHOAN VALUES ('TK0028', 'tqa28', N'123', N'Bác sĩ', 'BS0028');
INSERT INTO TAIKHOAN VALUES ('TK0029', 'tav29', N'123', N'Bác sĩ', 'BS0029');
INSERT INTO TAIKHOAN VALUES ('TK0030', 'htkq30', N'123', N'Bác sĩ', 'BS0030');
INSERT INTO TAIKHOAN VALUES ('TK0031', 'nqn31', N'123', N'Bác sĩ', 'BS0031');
INSERT INTO TAIKHOAN VALUES ('TK0032', 'dtt32', N'123', N'Bác sĩ', 'BS0032');
INSERT INTO TAIKHOAN VALUES ('TK0033', 'htl33', N'123', N'Bác sĩ', 'BS0033');
INSERT INTO TAIKHOAN VALUES ('TK0034', 'mmt34', N'123', N'Bác sĩ', 'BS0034');
INSERT INTO TAIKHOAN VALUES ('TK0035', 'lqh35', N'123', N'Bác sĩ', 'BS0035');
INSERT INTO TAIKHOAN VALUES ('TK0036', 'nvn36', N'123', N'Bác sĩ', 'BS0036');
INSERT INTO TAIKHOAN VALUES ('TK0037', 'dtd37', N'123', N'Bác sĩ', 'BS0037');
INSERT INTO TAIKHOAN VALUES ('TK0038', 'ttnl38', N'123', N'Bác sĩ', 'BS0038');
INSERT INTO TAIKHOAN VALUES ('TK0039', 'tdh39', N'123', N'Bác sĩ', 'BS0039');
INSERT INTO TAIKHOAN VALUES ('TK0040', 'ctn40', N'123', N'Bác sĩ', 'BS0040');
INSERT INTO TAIKHOAN VALUES ('TK0041', 'tdh41', N'123', N'Bác sĩ', 'BS0041');
INSERT INTO TAIKHOAN VALUES ('TK0042', 'ltla42', N'123', N'Bác sĩ', 'BS0042');
INSERT INTO TAIKHOAN VALUES ('TK0043', 'nvl43', N'123', N'Bác sĩ', 'BS0043');
INSERT INTO TAIKHOAN VALUES ('TK0044', 'lvk44', N'123', N'Bác sĩ', 'BS0044');
INSERT INTO TAIKHOAN VALUES ('TK0045', 'lnm45', N'123', N'Bác sĩ', 'BS0045');
INSERT INTO TAIKHOAN VALUES ('TK0046', 'qtbt46', N'123', N'Bác sĩ', 'BS0046');
INSERT INTO TAIKHOAN VALUES ('TK0047', 'ptx47', N'123', N'Bác sĩ', 'BS0047');
INSERT INTO TAIKHOAN VALUES ('TK0048', 'ptpt48', N'123', N'Bác sĩ', 'BS0048');
INSERT INTO TAIKHOAN VALUES ('TK0049', 'nqk49', N'123', N'Bác sĩ', 'BS0049');
INSERT INTO TAIKHOAN VALUES ('TK0050', 'dcl50', N'123', N'Bác sĩ', 'BS0050');

INSERT INTO PHIEUHEN VALUES ('PH0001', '02/01/2023', N'Sáng', 'BS0001', N'Buồn nôn, chóng mặt', N'Phạm Huy Tùng', '02/12/2003', N'Nam', '0269628526', N'122 Nguyễn Lương Bằng, Quang Trung, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0002', '02/02/2023', N'Chiều', 'BS0002', N'Đau bụng nhứt đầu', N'Lê Tuấn Tuyết', '02/10/1981', N'Nữ', '0797282312', N'258 Cù Chính Lan, Thanh Khê Đông, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0003', '03/02/2023', N'Sáng', 'BS0003', NULL, N'Đỗ Huy Ngọc Trinh', '03/12/1996', N'Nữ', '0517034901', N'202 Đ. Trương Định, Tương Mai, Hai Bà Trưng, Hà Nội');
INSERT INTO PHIEUHEN VALUES ('PH0004', '04/03/2023', N'Sáng', 'BS0004', NULL, N'Trương Văn Bích Ngọc', '20/07/1978', N'Nữ', '0012200884', N'27 Hai Bà Trưng, Bến Nghé, Quận 1, Hồ Chí Minh');
INSERT INTO PHIEUHEN VALUES ('PH0005', '05/02/2023', N'Sáng', 'BS0005', NULL, N'Mai Quang Hà My', '22/12/1975', N'Nữ', '0278250452', N'248 Võ Văn Tần, Phường 5, Quận 3, Hồ Chí Minh');
INSERT INTO PHIEUHEN VALUES ('PH0006', '06/03/2023', N'Chiều', 'BS0006', NULL, N'Triệu Đức An', '16/09/1978', N'Nam', '0127062401', N'20 Lê Thánh Tông, Cẩm Sơn, Hội An, Quảng Nam, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0007', '07/02/2023', N'Chiều', 'BS0007', NULL, N'Giang Phúc Quyết', '09/03/1954', N'Nam', '0269360334', N'58 ngõ 79, Hữu Nghị, Hòa Bình, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0008', '08/02/2023', N'Chiều', 'BS0008', NULL, N'Phùng Công Đông', '12/08/1987', N'Nam', '0675041817', N'404 Nguyễn Sơn, Phú Thọ Hoà, Tân Phú, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0009', '09/02/2023', N'Chiều', 'BS0009', NULL, N'Tống Văn Xuân', '24/10/1974', N'Nam', '0625793114', N'85 Huỳnh Ngọc Huệ, Thanh Khê Đông, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0010', '10/02/2023', N'Chiều', 'BS0010', NULL, N'Phùng Thành Thùy Linh', '03/01/1990', N'Nữ', '0562583388', N'45 Nguyễn Triệu Luật, Khu Phố 4, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0011', '11/03/2023', N'Sáng', 'BS0011', NULL, N'Trương Minh Hà', '20/05/1973', N'Nữ', '0084561757', N'31 P. Yên Thế, Văn Miếu, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0012', '12/02/2023', N'Chiều', 'BS0012', NULL, N'Phù Huy Ngọc Ánh', '22/11/1975', N'Nữ', '0378969265', N'HL2, Bình Trị Đông A, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0013', '13/02/2023', N'Chiều', 'BS0013', NULL, N'Lưu Hoàng Thị Hương', '11/06/1974', N'Nữ', '0855936553', N'28/1B Lê Đình Cẩn, P, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0014', '14/02/2023', N'Sáng', 'BS0014', NULL, N'Trịnh Hữu Vũ', '12/01/2004', N'Nam', '0987157069', N'K 123 Cù Chính Lan, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0015', '15/02/2023', N'Sáng', 'BS0015', NULL, N'Viễn Nguyễn Quang', '12/02/1994', N'Nam', '0481340734', N'A7/54 Đường 1C, Vĩnh Lộc B, Bình Chánh, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0016', '16/02/2023', N'Sáng', 'BS0016', NULL, N'Ngụy Phúc Bảo', '28/03/1990', N'Nam', '0824454073', N'281 P. Đội Cấn, Liễu Giai, Ba Đình, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0017', '17/02/2023', N'Chiều', 'BS0017', NULL, N'Sái Hoàng Nhật', '15/02/1999', N'Nam', '0226979476', N'Lạc Long Quân, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0018', '18/02/2023', N'Chiều', 'BS0018', NULL, N'Vi Thị Kiên', '24/10/1997', N'Nữ', '0083703932', N'7/3C Đ. Âu Cơ, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0019', '19/02/2023', N'Sáng', 'BS0019', NULL, N'Hà Thị Loan', '21/02/1967', N'Nữ', '0168823739', N'202 Đ. Tô Hiến Thành, Phường 15, Quận 11, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0020', '20/02/2023', N'Sáng', 'BS0020', NULL, N'Cung Đình Phú', '20/05/2017', N'Nam', '0002620708', N'24 Phạm Nhữ Tăng, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0021', '21/02/2023', N'Sáng', 'BS0021', NULL, N'Tô Đình Long', '25/12/1999', N'Nam', '0258522796', N'Ng. 1 800A, Nghĩa Đô, Cầu Giấy, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0022', '22/02/2023', N'Chiều', 'BS0022', NULL, N'Tô Văn Khang', '27/09/2021', N'Nam', '0407658210', N'226, Đường Hà Huy Tập, Phường Hòa Khê, Quận Thanh Khê, Hòa Khê, Thanh Khê, Đà Nẵng, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0023', '23/02/2023', N'Sáng', 'BS0023', NULL, N'Cáp Hoàng Minh Châu', '22/01/1975', N'Nữ', '0815421991', N'16F/B1 Ba Tháng Hai Tổ 40 KP 6, Phường 14, Quận 10, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0024', '24/02/2023', N'Chiều', 'BS0024', NULL, N'Trình Quang Thái', '12/10/1961', N'Nam', '0841478808', N'237 Đ. Cầu Giấy, Dịch Vọng, Cầu Giấy, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0025', '25/02/2023', N'Sáng', 'BS0025', NULL, N'Ngụy Hoàng Tuấn', '17/07/1965', N'Nam', '0552702699', N'249 Hà Huy Tập, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0026', '26/02/2023', N'Sáng', 'BS0026', NULL, N'Tô Hoàng Vy', '29/07/1984', N'Nữ', '0619899167', N'578 Đ. Nguyễn Chí Thanh, Phường 7, Quận 5, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0027', '27/02/2023', N'Chiều', 'BS0027', NULL, N'Nguyễn Ngọc Phong', '30/12/1979', N'Nam', '0766638154', N'25 Ngõ 329 Cầu Giấy, Dịch Vọng, Cầu Giấy, Hà Nội 100000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0028', '28/02/2023', N'Chiều', 'BS0028', NULL, N'Triệu Phúc Thái', '13/02/1976', N'Nam', '0785467500', N'C4 Cư Xá Phú Thọ Hoà, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0029', '01/03/2023', N'Chiều', 'BS0029', NULL, N'Tiết Hoàng Thùy Linh', '19/08/1980', N'Nữ', '0457679418', N'36 Xuân Thủy, Dịch Vọng Hậu, Cầu Giấy, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0030', '02/03/2023', N'Sáng', 'BS0030', NULL, N'Phí Nguyễn Ngọc Lan', '01/12/1986', N'Nữ', '0246071750', N'99B Thái Bình, Phường 4, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0031', '03/03/2023', N'Sáng', 'BS0031', NULL, N'Võ Hoàng Việt', '28/01/2016', N'Nam', '0345324336', N'36/23 Hẻm 36 Đồng Khởi, Phường 4, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0032', '04/03/2023', N'Sáng', 'BS0032', NULL, N'Hàm Thị Văn', '20/11/1992', N'Nam', '0201493281', N'203 Nguyễn Văn Linh, TT. Núi Thành, Núi Thành, Quảng Nam 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0033', '05/03/2023', N'Sáng', 'BS0033', NULL, N'Địch Thị Quỳnh Nga', '17/01/1963', N'Nữ', '0544045347', N'104 Đường B2, Tây Thạnh, Tân Phú, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0034', '06/03/2023', N'Chiều', 'BS0034', NULL, N'Lưu Thành Văn', '11/08/1974', N'Nam', '0250832780', N'33 Đ. Hoàng Diệu, Phường 12, Quận 4, Thành phố Hồ Chí Minh 700000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0035', '07/03/2023', N'Sáng', 'BS0035', NULL, N'Giang Văn Vy', '14/10/2004', N'Nam', '0072349208', N'28 Hàm Nghi, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh 700000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0036', '08/03/2023', N'Sáng', 'BS0044', NULL, N'Đồng Thị Hà My', '22/01/1956', N'Nữ', '0332378390', N'71-73-75 Hai Bà Trưng, Street, Quận 1, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0037', '09/03/2023', N'Chiều', 'BS0045', NULL, N'Vi Phúc Thanh Hương', '29/07/2006', N'Nữ', '0472037078', N'59 ngõ 79, Hữu Nghị, Hòa Bình, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0038', '10/03/2023', N'Chiều', 'BS0046', NULL, N'Cung Hoàng Ngọc Trinh', '23/02/1997', N'Nữ', '0703461097', N'Ngõ 30 Đường Phạm Văn Đồng, Mai Dịch, Bắc Từ Liêm, Hà Nội 10000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0039', '11/03/2023', N'Sáng', 'BS0047', NULL, N'Viên Thị Thắng', '16/01/1955', N'Nam', '0704383494', N'405 Nguyễn Sơn, Phú Thọ Hoà, Tân Phú, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0040', '12/03/2023', N'Sáng', 'BS0048', NULL, N'Lý Hữu Trí', '26/06/1979', N'Nam', '0204581339', N'86 Huỳnh Ngọc Huệ, Thanh Khê Đông, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0041', '13/03/2023', N'Sáng', 'BS0049', NULL, N'Đỗ Văn Ngọc Diệp', '20/11/1956', N'Nữ', '0809874862', N'46 Nguyễn Triệu Luật, Khu Phố 4, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0042', '14/03/2023', N'Sáng', 'BS0050', NULL, N'Ngô Đình Hoa', '15/04/1996', N'Nữ', '0143825471', N'32 P. Yên Thế, Văn Miếu, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0043', '15/03/2023', N'Sáng', 'BS0001', NULL, N'Mã Văn Thu', '18/05/1998', N'Nam', '0282318547', N'HL2, Bình Trị Đông A, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0044', '16/03/2023', N'Sáng', 'BS0002', NULL, N'Đậu Anh Bảo', '11/12/1979', N'Nam', '0579532527', N'28/1B Lê Đình Cẩn, P, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0045', '17/03/2023', N'Sáng', 'BS0003', NULL, N'Tạ Hoàng Tuấn', '06/06/1955', N'Nam', '0895025939', N'K 123 Cù Chính Lan, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0046', '18/03/2023', N'Chiều', 'BS0004', NULL, N'Mai Văn Phương', '31/12/1965', N'Nam', '0342615880', N'A7/54 Đường 1C, Vĩnh Lộc B, Bình Chánh, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0047', '19/03/2023', N'Chiều', 'BS0005', NULL, N'Khúc Thành Anh', '12/09/1979', N'Nam', '0746131570', N'282 P. Đội Cấn, Liễu Giai, Ba Đình, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0048', '20/03/2023', N'Sáng', 'BS0006', NULL, N'Phạm Huy Ngọc Ánh', '18/05/1990', N'Nữ', '0122983232', N'Lạc Long Quân, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0049', '21/03/2023', N'Sáng', 'BS0007', NULL, N'Ôn Thị Trung', '13/08/2008', N'Nữ', '0825794952', N'7/3C Đ. Âu Cơ, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0050', '22/03/2023', N'Sáng', 'BS0008', NULL, N'Nhâm Duy Loan', '29/05/1969', N'Nữ', '0746554697', N'203 Đ. Tô Hiến Thành, Phường 15, Quận 11, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0051', '23/03/2023', N'Chiều', 'BS0009', NULL, N'Khúc Hoàng Phúc', '03/09/2018', N'Nam', '0282437723', N'25 Phạm Nhữ Tăng, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0052', '24/03/2023', N'Chiều', 'BS0010', NULL, N'Phù Văn Thanh Hương', '21/10/1950', N'Nữ', '0795438089', N'Ng. 1 800A, Nghĩa Đô, Cầu Giấy, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0053', '25/03/2023', N'Sáng', 'BS0011', NULL, N'Tôn Công Hà', '13/04/2016', N'Nam', '0163671750', N'226, Đường Hà Huy Tập, Phường Hòa Khê, Quận Thanh Khê, Hòa Khê, Thanh Khê, Đà Nẵng, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0054', '26/03/2023', N'Sáng', 'BS0012', NULL, N'Đàm Ngọc Yến', '22/04/2015', N'Nữ', '0571144640', N'16F/B1 Ba Tháng Hai Tổ 40 KP 6, Phường 14, Quận 10, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0055', '27/03/2023', N'Chiều', 'BS0013', NULL, N'Doãn Anh Minh Tuấn', '02/09/1971', N'Nam', '0102831102', N'238 Đ. Cầu Giấy, Dịch Vọng, Cầu Giấy, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0056', '28/03/2023', N'Sáng', 'BS0014', NULL, N'Tô Hoài Hoa', '10/06/1983', N'Nữ', '0167098927', N'250 Hà Huy Tập, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0057', '29/03/2023', N'Sáng', 'BS0015', NULL, N'Lâm Văn Linh', '19/06/1996', N'Nam', '0342984493', N'579 Đ. Nguyễn Chí Thanh, Phường 7, Quận 5, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0058', '30/03/2023', N'Chiều', 'BS0016', NULL, N'Hà Công Tân', '25/02/1997', N'Nam', '0097678943', N'26 Ngõ 329 Cầu Giấy, Dịch Vọng, Cầu Giấy, Hà Nội 100000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0059', '31/03/2023', N'Sáng', 'BS0017', NULL, N'Trịnh Thị Hoàng', '08/05/2005', N'Nữ', '0329960334', N'C4 Cư Xá Phú Thọ Hoà, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0060', '01/04/2023', N'Chiều', 'BS0018', NULL, N'Mai Phúc Long', '27/09/1963', N'Nam', '0578597387', N'37 Xuân Thủy, Dịch Vọng Hậu, Cầu Giấy, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0061', '02/04/2023', N'Sáng', 'BS0019', NULL, N'Tôn Văn Kim', '11/08/1986', N'Nam', '0342880951', N'99B Thái Bình, Phường 4, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0062', '03/04/2023', N'Chiều', 'BS0020', NULL, N'Cù Hữu Nhật', '30/08/2003', N'Nam', '0812499826', N'36/23 Hẻm 36 Đồng Khởi, Phường 4, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0063', '04/04/2023', N'Chiều', 'BS0021', NULL, N'Quản Văn Đức', '19/01/2000', N'Nam', '0245767912', N'204 Nguyễn Văn Linh, TT. Núi Thành, Núi Thành, Quảng Nam 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0064', '05/04/2023', N'Chiều', 'BS0022', NULL, N'Phù Đình Thúy', '24/05/1978', N'Nữ', '0307214330', N'105 Đường B2, Tây Thạnh, Tân Phú, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0065', '06/04/2023', N'Sáng', 'BS0023', NULL, N'Khắc Quang Ánh', '05/03/2007', N'Nam', '0877856155', N'34 Đ. Hoàng Diệu, Phường 12, Quận 4, Thành phố Hồ Chí Minh 700000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0066', '07/04/2023', N'Sáng', 'BS0024', NULL, N'Vi Huy Lan', '18/12/2014', N'Nữ', '0629774350', N'Ngõ 30 Đường Phạm Văn Đồng, Mai Dịch, Bắc Từ Liêm, Hà Nội 10000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0067', '08/04/2023', N'Sáng', 'BS0025', NULL, N'Khúc Thanh Phúc', '05/06/1957', N'Nam', '0153774013', N'29 Hàm Nghi, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh 700000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0068', '09/04/2023', N'Sáng', 'BS0026', NULL, N'Tô Đình Huyền Trang', '12/05/1959', N'Nữ', '0116182693', N'71-73-75 Hai Bà Trưng, Street, Quận 1, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0069', '10/04/2023', N'Sáng', 'BS0027', NULL, N'Ngụy Thanh Thành', '07/01/1986', N'Nữ', '0459534966', N'60 ngõ 79, Hữu Nghị, Hòa Bình, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0070', '11/04/2023', N'Sáng', 'BS0028', NULL, N'Sái Thị Kim', '05/10/1978', N'Nữ', '0883251224', N'406 Nguyễn Sơn, Phú Thọ Hoà, Tân Phú, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0071', '12/04/2023', N'Sáng', 'BS0029', NULL, N'Bùi Phúc Quang', '17/06/1972', N'Nam', '0614822096', N'87 Huỳnh Ngọc Huệ, Thanh Khê Đông, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0072', '13/04/2023', N'Chiều', 'BS0030', NULL, N'Tôn Huy Lâm', '14/08/1975', N'Nam', '0429727318', N'47 Nguyễn Triệu Luật, Khu Phố 4, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0073', '14/04/2023', N'Sáng', 'BS0031', NULL, N'Vương Văn Thắng', '22/07/1969', N'Nam', '0304378000', N'33 P. Yên Thế, Văn Miếu, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0074', '15/04/2023', N'Sáng', 'BS0032', NULL, N'Trầm Hoài Phúc', '23/04/1998', N'Nam', '0310541533', N'HL2, Bình Trị Đông A, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0075', '16/04/2023', N'Chiều', 'BS0033', NULL, N'Bùi Thị Phúc', '05/11/2003', N'Nữ', '0787096071', N'K 123 Cù Chính Lan, Hòa Khê, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0076', '17/04/2023', N'Sáng', 'BS0034', NULL, N'Lâm Hoài Thùy Linh', '15/05/2005', N'Nữ', '0706015508', N'28/1B Lê Đình Cẩn, P, Bình Tân, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0077', '18/04/2023', N'Chiều', 'BS0035', NULL, N'Văn Nguyễn Yến', '04/10/1981', N'Nữ', '0313692775', N'A7/54 Đường 1C, Vĩnh Lộc B, Bình Chánh, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0078', '19/04/2023', N'Sáng', 'BS0044', NULL, N'Kiều Nguyễn Thanh Thảo', '05/11/1999', N'Nữ', '0910926390', N'283 P. Đội Cấn, Liễu Giai, Ba Đình, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0079', '20/04/2023', N'Sáng', 'BS0045', NULL, N'Văn Huy Ngọc Mai', '16/11/1974', N'Nữ', '0193535313', N'Lạc Long Quân, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0080', '21/04/2023', N'Chiều', 'BS0046', NULL, N'Khúc Hoài Khánh', '16/09/2001', N'Nam', '0241786228', N'7/3C Đ. Âu Cơ, Phường 10, Tân Bình, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0081', '22/04/2023', N'Chiều', 'BS0047', NULL, N'Tôn Đức Minh', '08/05/1986', N'Nam', '0174511089', N'46/1A Đỗ Nhuận, Sơn Kỳ, Tân Phú, TP.HCM');
INSERT INTO PHIEUHEN VALUES ('PH0082', '23/04/2023', N'Sáng', 'BS0048', NULL, N'Đàm Công Ngọc Trinh', '03/08/1956', N'Nữ', '0140441630', N'16 P. Nguyễn Quang Bích. Cửa Đông. Hoàn Kiếm. Hà Nội 10000. Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0083', '24/04/2023', N'Sáng', 'BS0049', NULL, N'Khúc Quang Ngọc Yến', '30/09/1956', N'Nữ', '0898999040', N'88 Lê Văn Duyệt, Đa Kao, Quận 1, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0084', '25/04/2023', N'Sáng', 'BS0050', NULL, N'Nông Phúc Hà', '10/06/1977', N'Nam', '0008201235', N'21 5 Tháng 6, Tổ dân phố số 16, Thị xã Lai Châu, Lai Châu, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0085', '26/04/2023', N'Sáng', 'BS0021', NULL, N'Cáp Thành Long', '07/09/1973', N'Nam', '0146292469', N'107 Minh Khai, Phố Mới, Lào Cai, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0086', '27/04/2023', N'Chiều', 'BS0022', NULL, N'Ôn Văn Long', '20/03/1981', N'Nam', '0476426220', N'876 Trần Cao Vân, Thanh Khê Đông, Thanh Khê, Đà Nẵng, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0087', '28/04/2023', N'Chiều', 'BS0023', NULL, N'Nhâm Hoàng Ngọc Diệp', '08/07/2002', N'Nữ', '0120215526', N'Ng. 34 P. Hào Nam, Chợ Dừa, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0088', '29/04/2023', N'Sáng', 'BS0024', NULL, N'Viễn Thành Mai Phương', '31/03/1957', N'Nữ', '0410554823', N'164 Nguyễn Thông, Bình Tâm, Tân An, Long An, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0089', '30/04/2023', N'Sáng', 'BS0025', NULL, N'Khổng Thanh Đức', '30/09/2017', N'Nam', '0208293459', N'108 Thái Bình, Trần Tế Xương, TP. Nam Định, Nam Định, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0090', '01/05/2023', N'Sáng', 'BS0026', NULL, N'Mã Văn Ngọc Yến', '21/11/2000', N'Nữ', '0550821125', N'573 Điện Biên Phủ, Thanh Khê Đông, Thanh Khê, Đà Nẵng 550000, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0091', '02/05/2023', N'Chiều', 'BS0027', NULL, N'Phú Phúc Ngọc Mai', '05/06/1971', N'Nữ', '0608019402', N'79 Đ. La Thành, Chợ Dừa, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0092', '03/05/2023', N'Chiều', 'BS0028', NULL, N'Châu Anh Gia Hân', '04/06/2023', N'Nữ', '0780329453', N'198 Nguyễn Lương Bằng, Quang Trung, Đống Đa, Hà Nội, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0093', '04/05/2023', N'Chiều', 'BS0029', NULL, N'Khổng Hoàng Thái', '28/09/2003', N'Nam', '0506997384', N'12 Hà Liễu, Ph.Gia Cẩm, Thành phố Việt Trì, Phú Thọ, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0094', '05/05/2023', N'Sáng', 'BS0030', NULL, N'Duy Thị Thảo', '18/10/1975', N'Nữ', '0168753181', N'112 Đ. Đinh Tiên Hoàng, Đa Kao, Quận 1, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0095', '06/05/2023', N'Chiều', 'BS0022', NULL, N'Bàng Minh Diệu', '09/08/2012', N'Nam', '0052062068', N'9 Đ. Phan Đăng Lưu, Phường 3, Bình Thạnh, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0096', '07/05/2023', N'Sáng', 'BS0023', NULL, N'Khải Công Quốc', '01/12/2003', N'Nam', '0277797848', N'12 Nơ Trang Long, Phường 14, Bình Thạnh, Thành phố Hồ Chí Minh, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0097', '08/05/2023', N'Sáng', 'BS0024', NULL, N'Thi Tuấn Hoài', '24/03/2010', N'Nam', '0918765429', N'90 Phạm Văn Đồng, Nghĩa Chánh Bắc, Quảng Ngãi, Việt Nam');
INSERT INTO PHIEUHEN VALUES ('PH0098', '09/05/2023', N'Chiều', 'BS0033', NULL, N'Ứng Hoàng Vũ', '12/02/1998', N'Nam', '0801991858', N'1 Đ. Phan Đăng Lưu, phường 03, Bình Thạnh, Thành phố Hồ Chí Minh 72300, Việt Nam');
...
INSERT INTO PHONGKHAM VALUES ('F31', N'Phòng khám bệnh sốt rét', N'Tầng 3 khu F');						
